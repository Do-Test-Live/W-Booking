...
<head>
    ...
    <title>Package Sell Data Admin | Broadway Driving School</title>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    ...
                                                    if ($package_sell_data[$i]["approve"] == 3) {
                                                        ?>
                                                        <a href="Payment?id=<?php echo $package_sell_data[$i]["id"]; ?>" class="btn btn-success shadow btn-xs sharp mr-1"><i
